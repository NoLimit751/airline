...
object Model {
  ...
  val models = List(Model("Cessna 421", "Cessna", capacity = 7, fuelBurn = (7 * 1).toInt, speed = 300, range = 1555, price = 550000, lifespan = 35 * 52, constructionTime = 0, Manufacturer("Cessna", countryCode = "US"), runwayRequirement = 708),
    ...
    Model("Airbus A220-100", "Airbus A220", capacity = 133, fuelBurn = (133 * 3.1).toInt, speed = 828, range = 3690, price = 80000000, lifespan = 35 * 52, constructionTime = 8, Manufacturer("Airbus", countryCode = "NL"), runwayRequirement = 1463, imageUrl = "https://www.norebbo.com/2016/02/bombardier-cs100-blank-illustration-templates/"),
    Model("Airbus A220-300", "Airbus A220", capacity = 160, fuelBurn = (160 * 3.3).toInt, speed = 828, range = 6667, price = 98000000, lifespan = 35 * 52, constructionTime = 20, Manufacturer("Airbus", countryCode = "NL"), runwayRequirement = 1890, imageUrl = "https://www.norebbo.com/2016/02/bombardier-cs300-blank-illustration-templates/"),
